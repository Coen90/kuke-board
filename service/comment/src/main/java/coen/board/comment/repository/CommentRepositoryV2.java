package coen.board.comment.repository;
...
public interface CommentRepositoryV2 extends JpaRepository<CommentV2, Long> {
    ...
    Long count(Long articleId, Long limit);
    ...
    List<CommentV2> findAllInfiniteScroll(Long articleId, Long limit);
    ...
    List<CommentV2> findAllInfiniteScroll(Long articleId, String lastPath, Long limit);
}
